    ...
    return (
        <section className='w-screen min-h-dvh px-6 mt-10 pb-24 flex flex-col'>
            ...
            <div className='flex flex-col md:flex-row md:justify-between md:items-center mt-8 md:mt-14 gap-8 md:gap-0'>
                <h3 className='text-[#9e9b93] text-lg md:text-2xl'>If you're seeking a retreat that<br />
                ...
                <div className='flex flex-row flex-wrap md:flex-col justify-start md:justify-center items-start md:items-end gap-x-4 gap-y-1 md:gap-0'>
                    <a href="#rooms" className='text-[#e8e4dc] text-xl md:text-2xl'>Rooms</a>
                    <a href="#experiences" className='text-[#e8e4dc] text-xl md:text-2xl'>Experiences</a>
                    <a href="#dining" className='text-[#e8e4dc] text-xl md:text-2xl'>Dining</a>
                    <a href="#wellness" className='text-[#e8e4dc] text-xl md:text-2xl'>Wellness</a>
                    <a href="#gallery" className='text-[#e8e4dc] text-xl md:text-2xl'>Gallery</a>
                    <a onClick={(e) => { e.preventDefault(); window.dispatchEvent(new Event("open-reserve-modal")); }} href="#" className='text-[#e8e4dc] text-xl md:text-2xl cursor-pointer'>Reserve</a>
                </div>
            </div>
